    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="translate(59.000000, 211.881084)">
        ...
        <polygon
          fill="#757575"
          className="no-fill"
          transform="translate(294.904234, 114.470962) scale(-1, 1) translate(-294.904234, -114.470962)"
      ...
      <g transform="translate(59.000000, 85.000000)">
        ...
        <polygon
          fill="#E0E0E0"
          className="no-fill"
          transform="translate(255.087198, 63.440542) scale(-1, 1) translate(-255.087198, -63.440542)"
          points="313.572 0 202.759 11.715 196.603 126.881"
        />
        <polygon
          fill="#BDBDBD"
          className="no-fill"
          transform="translate(350.310484, 69.298119) scale(-1, 1) translate(-350.310484, -69.298119)"
        ...
        />
        <polygon points="196.603 0 79.634 126.881 313.572 126.881" />
      </g>
    </g>
  </svg>
);
