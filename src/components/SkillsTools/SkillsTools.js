...
const SkillsTools = () => (
  <div className={styles.category}>
    ...
    <SkillItem
      icon={<IconGithub width="64px" height="64px" />}
      skillName="GitHub"
    />
    <SkillItem
      icon={<IconWebpack width="64px" height="64px" />}
      skillName="Webpack"
    />
    <SkillItem
      icon={<IconGulp width="64px" height="64px" />}
      skillName="Gulp"
    />
    <SkillItem
      icon={<IconGrunt width="64px" height="64px" />}
      skillName="Grunt"
    />
  </div>
);
